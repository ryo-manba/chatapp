...
export class ChatService {
  ...
  async chatRoom(charRoomWhereUniqueInput: Prisma.ChatRoomWhereUniqueInput): Promise<ChatRoom | null> {
  ...
  async deleteChatRoom(where: Prisma.ChatRoomWhereUniqueInput): Promise<ChatRoom> {
